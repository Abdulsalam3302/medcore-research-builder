...
export const designs: DesignSpec[] = [
  ...
  /* ---------- 4. PROTOCOLS ---------- */
  {
    ...
    primaryGuideline: {
      acronym: "SPIRIT 2013",
      fullName: "SPIRIT: Standard Protocol Items: Recommendations for Interventional Trials",
      year: "2013",
    ...
    whenToUseChecklist: [
      "Document describes the planned conduct of a clinical trial.",
    ...
    reportingChecklist: {
      ...
      abstract: ["Provide a structured abstract per SPIRIT recommendations."],
